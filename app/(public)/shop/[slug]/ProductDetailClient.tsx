          ...
          <div className="mt-8 lg:mt-0">
            ...
            {product.brand && (
              <div className="mt-4 overflow-hidden rounded-2xl border border-neutral-100">
                {/* Verified badge row */}
                <div className="flex items-center gap-2.5 px-4 py-3" style={{ background: "linear-gradient(90deg,rgba(218,170,88,0.08) 0%,rgba(244,202,104,0.04) 100%)" }}>
                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full" style={{ background: BRAND_GRADIENT }}>
                    <svg className="h-3.5 w-3.5 text-zinc-950" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
                    </svg>
                  </span>
                  <div>
                    <p className="text-[11px] font-black uppercase tracking-widest" style={{ color: BRAND_GOLD }}>Verified & Authentic</p>
                    <p className="text-[10px] text-neutral-400 mt-0.5">Sold by an approved IFI Lifestyle vendor</p>
                  </div>
                </div>
                {/* Brand row */}
                <div className="flex items-center justify-between border-t border-neutral-100 px-4 py-2.5 text-xs">
