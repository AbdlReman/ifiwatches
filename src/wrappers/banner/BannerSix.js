        ...
        <div className="row">
          <div className="col-lg-6 col-md-6">
            <div className="single-banner mb-20">
              ...
              <div className="banner-content-4 banner-position-hm15-2 brand-banner">
                <span>-20% Off</span>
                <h2>New Tulip</h2>
          ...
          <div className="col-lg-6 col-md-6">
            <div className="single-banner mb-20">
              ...
              <div className="banner-content-3 banner-position-hm15-2 brand-banner">
                <h3>Pink Tulip </h3>
                <p>
            ...
            <div className="single-banner mb-20">
              ...
              <div className="banner-content-3 banner-position-hm17-1 brand-banner">
                <h3>Pink Tulip </h3>
                <p>
                  Starting At <span>$99.00</span>
                </p>
