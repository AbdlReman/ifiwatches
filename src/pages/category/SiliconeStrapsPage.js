  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for silicone straps category using the category mapper
        const siliconeStrapsProducts = items.filter(product => 
          hasCategory(product, "siliconestraps")
        );
        
        setProducts(siliconeStrapsProducts);
        setSortedProducts(siliconeStrapsProducts);
        setCurrentData(siliconeStrapsProducts.slice(0, pageLimit));
      } catch (error) {
      ...
      <LayoutOne headerTop="visible">
        <Breadcrumb
          pages={[
            ...
            { label: "Silicone/Rubber Straps", path: process.env.PUBLIC_URL + "/watch-straps/silicone" },
          ]}
        />
        <div className="shop-area pt-95 pb-100">
          <div className="container">
...
export default SiliconeStrapsPage; 