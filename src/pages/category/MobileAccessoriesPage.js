...
const MobileAccessoriesPage = () => {
  ...
  useEffect(() => {
    ...
    // Filter by mobile accessories category
    filtered = filtered.filter(product =>
      product.category && 
      (Array.isArray(product.category) ? 
        product.category.includes('mobileaccessories') : 
  ...
  return (
    <Fragment>
      <SEO 
                titleTemplate="Mobile Accessories - Lanina"
        description="Shop premium mobile accessories at Lanina. Quality phone accessories with excellent service and reliability. Visit https://www.lanina.pk/" 
      />
                  ...
                  <div className="category-header mb-4">
                    <div className="row">
                      <div className="col-12">
                        <h1 className="category-title">Mobile Accessories</h1>
                        <p className="category-description">
                          Discover our premium collection of mobile accessories. 
                          Quality phone accessories with excellent service.
                        </p>
                      </div>
                    </div>
                  </div>
