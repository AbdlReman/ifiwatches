...
const WomensPerfumesPage = () => {
  ...
  return (
    <Fragment>
      <SEO 
                titleTemplate="Women's Fragrances - IFILifestyle"
        description="Shop elegant women's fragrances at IFILifestyle. Beautiful scents for the sophisticated woman." 
      />
      <LayoutOne headerTop="visible">
        <Breadcrumb
          pages={[
            ...
            { label: "Women's Fragrances", path: process.env.PUBLIC_URL + "/perfumes/womens" },
          ]}
        />
        <div className="shop-area pt-95 pb-100">
          <div className="container">
...
export default WomensPerfumesPage; 