  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for top categories (most popular products)
        const topCategoriesProducts = items.filter(product =>
          product.category && (
            product.category.includes("menwatches") ||
            product.category.includes("womenwatches") ||
            product.category.includes("leatherstraps") ||
            product.category.includes("mensperfumes") ||
            product.category.includes("womensperfumes") ||
            product.category.includes("sunglasses")
          )
        );
  ...
  return (
    <Fragment>
      <SEO
        ...
        description="Discover our most popular categories at IFIwatches. Shop the best in watches, straps, perfumes, and accessories."
      />
