...
const LuxuryWatchesPage = () => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const luxuryWatchesProducts = items.filter(product =>
          hasCategory(product, "luxurywatches")
        );
  ...
  return (
    <Fragment>
      <SEO
        titleTemplate="Luxury Collection - IFIwatches"
        description="Shop premium luxury watches at IFIwatches. Exclusive timepieces for the discerning collector."
      />
      <LayoutOne headerTop="visible">
        <Breadcrumb
          pages={[
            ...
            { label: "Luxury Collection", path: process.env.PUBLIC_URL + "/watches/luxury" },
          ]}
        />
