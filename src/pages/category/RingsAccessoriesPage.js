...
const RingsAccessoriesPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for rings & accessories category using the category mapper
  ...
  return (
    <Fragment>
      <SEO 
                titleTemplate="Rings & Accessories - IFILifestyle"
        description="Shop elegant rings and accessories at IFILifestyle. Fashion rings, chains, and bracelets for every style." 
      />
      <LayoutOne headerTop="visible">
        ...
        <div className="shop-area pt-95 pb-100">
          <div className="container">
            <ChildCategoryButtons parentCategory="rings-accessories" />
            <div className="row">
