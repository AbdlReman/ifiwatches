  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter for watch straps category
        const watchStrapsProducts = items.filter(product => 
          product.category && product.category.includes("watchstraps")
        );
        
        setProducts(watchStrapsProducts);
        setSortedProducts(watchStrapsProducts);
        setCurrentData(watchStrapsProducts.slice(0, pageLimit));
      } catch (error) {
  ...
  return (
    <Fragment>
      ...
      <LayoutOne headerTop="visible">
        ...
        <div className="shop-area pt-95 pb-100">
          <div className="container">
            <ChildCategoryButtons parentCategory="watch-straps" />
            <div className="row">
...
export default WatchStrapsPage; 